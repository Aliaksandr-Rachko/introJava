package by.epam.introductiontojava.tasks_6.task02.main;
...
import by.epam.introductiontojava.tasks_6.task02.view.View;
import by.epam.introductiontojava.tasks_6.task02.entity.Note;
import by.epam.introductiontojava.tasks_6.task02.loader.DataLoader;
import by.epam.introductiontojava.tasks_6.task02.utils.NoteDao;


public class Main {
    public static void main(String[] args) {
        DataLoader<Note> userDataLoader = new DataLoader<>(
                "./src/main/java/by/epam/introductiontojava/tasks_6/task02/resources/notes.txt"
        );
